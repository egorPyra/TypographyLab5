...
export default function Rustik() {
    ...
    return (
        <div className={styles.container}>
            ...
            <p className={styles.i}>&laquo;рустика&raquo; (или &laquo;рустический шрифт&raquo;), появился в&nbsp;Древнем Риме. Рустический шрифт (лат. scriptura rustica) был широко использован в&nbsp;древнеримских рукописях с&nbsp;1-го по&nbsp;6-й века нашей эры. Он&nbsp;был менее формальным и&nbsp;более простым по&nbsp;сравнению с&nbsp;другими рукописными шрифтами того времени, такими как унциал или квадратный капитальный шрифт.</p>
